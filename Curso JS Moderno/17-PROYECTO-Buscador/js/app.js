...
// Event listener para los Señect de usqueda
...
// Funcion de filtrar en base a la busqueda 
function filtrarAuto(){
    const resultado = autos.filter(filtrarMarca).filter(filtrarYear).filter(filtrarMinimo).
    filter(filtrarMaximo).filter(filtrarPuertas).filter(filtrarTransaccion).filter(filtrarColor)
...
function filtrarTransaccion(auto){
